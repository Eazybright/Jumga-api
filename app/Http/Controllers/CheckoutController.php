...
class CheckoutController extends Controller
{
   ...
   * @bodyParam callback_url url required function that runs when payment is successful. it should call api/checkout/order/confirm endpoint to continue order processing 
   ...
   * @bodyParam transaction_id numeric required This is the transaction_id that flutterwave sent to the callback url
   * @bodyParam order_number string required This is the unique generated by the system when the order was made
   * @response {
   *       "status": true,
